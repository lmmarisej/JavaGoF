...
public class SafeFrame extends Frame implements ActionListener, Context {
    ...
    private final Button buttonUse = new Button("使用金库");      // 金库使用按钮
    private final Button buttonAlarm = new Button("按下警铃");    // 按下警铃按钮
    private final Button buttonPhone = new Button("正常通话");    // 正常通话按钮
    private final Button buttonExit = new Button("结束");         // 结束按钮
